<style type=text/css> .header {
    background-image: linear-gradient(rgba(4,9,30,0.7),rgba(4,9,30,0.7)),url(img/planting02.jpg);}
</style>
...
<?php require_once('inc/header.php'); ?>
  <div class="text-box">
        <h1>Who We Are ?</h1>
        <p>Today, more and more companies are creating products that help us live a green lifestyle. </p>
...
<p>Master Plan is a living document that communicates a sustainable vision for the next 100 years. By setting the direction for current and future residents, 
...
Each green space has been developed to determine the arrangement of water elements, circulation patterns, structure locations, parking zones, and new landscapes.</p>

<h2>Our Mission</h2>
<p>These arrangements are coupled with principles of design that center on sustainability, which inform the final layout and material choices for each garden space.<br>
	<br>
